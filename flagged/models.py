...
class Flag(models.Model):
    ...
    user = models.ForeignKey(User, verbose_name="name", related_name="%(class)s_rating")
    submit_date = models.DateTimeField("date/time submitted", auto_now=True)
...
def inform_feedback_of_flag(sender, instance, **kwargs):
    ...
    try:
        send_mail("Content Flagged", template.render(Context(context)), None, [SITE_FEEDBACK_EMAIL], fail_silently=False)
        return True
