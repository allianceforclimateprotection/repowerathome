...
DATABASE_NAME     = 'rah_dev'          # Or path to database file if using sqlite3.
DATABASE_USER     = 'rah'              # Not used with sqlite3.
DATABASE_PASSWORD = 'RromTP=8S$F]@07O' # Not used with sqlite3.
