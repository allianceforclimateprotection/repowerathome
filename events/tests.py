...
class EventTest(TestCase):
    fixtures = ["surveys.json", "test_geo_02804.json", "test_events.json",]
...
class GuestTest(TestCase):
    fixtures = ["surveys.json", "test_events.json",]
...
class EventCreateViewTest(TestCase):
    ...
    def test_missing_required(self):
        self.client.login(username="test@test.com", password="test")
        response = self.client.post(self.event_create_url, {"where": "",
            "when": "", "title": "",
        ...
        self.failUnless("title" in errors)
...
class EventGuestsInviteViewTest(TestCase):
    fixtures = ["surveys.json", "test_geo_02804.json", "test_events.json", "invite.json"]
